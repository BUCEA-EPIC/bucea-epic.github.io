...
const SITE_TITLE = '光启Ray-space工作室'
...
const routes = [
  ...
  { path: '/about', name: 'About', component: () => import('../views/AboutView.vue'), meta: { title: '关于我们', description: '北京建筑大学光启Ray-space工作室，围绕真实工程问题整合机械结构、电控系统、嵌入式与感知算法，带成员从基础学习走向系统协同。' } },
  { path: '/team', name: 'Team', component: () => import('../views/TeamView.vue'), meta: { title: '团队成员', description: '认识光启Ray-space工作室的指导教师与学生团队，来自不同专业背景，在长期协作中共同完成机器人与工程实践项目。' } },
  { path: '/projects', name: 'Projects', component: () => import('../views/ProjectsView.vue'), meta: { title: '项目与机器人', description: '浏览光启Ray-space工作室的机器人与工程实践作品，涵盖机械设计、电路控制与嵌入式编程的完整项目案例。' } },
  ...
  { path: '/event/:editionId(\\d+)', name: 'EventEdition', component: () => import('../views/EventView.vue'), meta: { title: '萌新种子杯', description: '“萌新种子杯”是光启Ray-space工作室面向新成员的工程实践赛事，涵盖视觉循迹、电源设计与三维建模等赛道。' } },
...
router.afterEach((to, from) => {
  document.title = to.meta.title ? `${to.meta.title} | 光启Ray-space工作室` : SITE_TITLE
